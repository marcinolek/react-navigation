...
class TabBarBottom extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "showListener", void 0);

    _defineProperty(this, "hideListener", void 0);
  ...
  componentDidMount() {
    if (_reactNative.Platform.OS === 'ios') {
      this.showListener = _reactNative.Keyboard.addListener('keyboardWillShow', this._handleKeyboardShow);
      this.hideListener = _reactNative.Keyboard.addListener('keyboardWillHide', this._handleKeyboardHide);
    } else {
      this.showListener = _reactNative.Keyboard.addListener('keyboardDidShow', this._handleKeyboardShow);
      this.hideListener = _reactNative.Keyboard.addListener('keyboardDidHide', this._handleKeyboardHide);
    }
  }
