...
class TabBarBottom extends React.Component {
  ...
  componentDidMount() {
    if (Platform.OS === 'ios') {
      this.showListener = Keyboard.addListener('keyboardWillShow', this._handleKeyboardShow);
      this.hideListener = Keyboard.addListener('keyboardWillHide', this._handleKeyboardHide);
    } else {
      this.showListener = Keyboard.addListener('keyboardDidShow', this._handleKeyboardShow);
      this.hideListener = Keyboard.addListener('keyboardDidHide', this._handleKeyboardHide);
    }
  }
